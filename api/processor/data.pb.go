...
type StreamTransactionRequest struct {
	...
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Uid           string                 `protobuf:"bytes,2,opt,name=uid,proto3" json:"uid,omitempty"`
	Amo           uint32                 `protobuf:"varint,3,opt,name=amo,proto3" json:"amo,omitempty"`
...
func (x *StreamTransactionRequest) GetAmo() uint32 {
	if x != nil {
		return x.Amo
	}
	return 0
...
var file_processor_data_proto_rawDesc = string([]byte{
	...
	0x12, 0x10, 0x0a, 0x03, 0x61, 0x6d, 0x6f, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x61,
