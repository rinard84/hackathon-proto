...
func (x *StreamTransactionRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *StreamTransactionRequest) GetUid() string {
	if x != nil {
		return x.Uid
	}
	return ""
...
func (x *StreamTransactionRequest) GetAction() string {
	if x != nil {
		return x.Action
	}
	return ""
...
func (x *StreamTransactionResponse) GetBalance() int64 {
	if x != nil {
		return x.Balance
	}
	return 0
...
var file_processor_data_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x03, 0x75, 0x69, 0x64, 0x22, 0x0e, 0x0a, 0x0c, 0x52, 0x65, 0x73, 0x65, 0x74,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x49, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x64, 0x69,
	0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x69, 0x64, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x69, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x6d,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x69, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x69, 0x6d,
	...
	0x6f, 0x6e, 0x22, 0x6c, 0x0a, 0x18, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x54, 0x72, 0x61, 0x6e,
	...
	0x22, 0x47, 0x0a, 0x19, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61,
	...
	0x52, 0x07, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x42, 0xc5, 0x01, 0x0a, 0x19, 0x63, 0x6f,
...
var file_processor_data_proto_goTypes = []any{
	...
	(*CreditResponse)(nil),                    // 3: backend.processor.api.CreditResponse
	(*DebitRequest)(nil),                      // 4: backend.processor.api.DebitRequest
	(*DebitResponse)(nil),                     // 5: backend.processor.api.DebitResponse
	(*GetUserBalanceRequest)(nil),             // 6: backend.processor.api.GetUserBalanceRequest
	(*GetUserBalanceResponse)(nil),            // 7: backend.processor.api.GetUserBalanceResponse
	(*ListUserTransactionsRequest)(nil),       // 8: backend.processor.api.ListUserTransactionsRequest
	(*ListUserTransactionsResponse)(nil),      // 9: backend.processor.api.ListUserTransactionsResponse
	(*StreamTransactionRequest)(nil),          // 10: backend.processor.api.StreamTransactionRequest
	(*StreamTransactionResponse)(nil),         // 11: backend.processor.api.StreamTransactionResponse
